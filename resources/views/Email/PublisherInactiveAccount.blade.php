                    ...
                    <tr>
                      <td class="sm-px-24" style="--bg-opacity: 1; background-color: #ffffff; border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding: 48px; text-align: left; --text-opacity: 1; color: #626262;" align="left">
                        <p style="font-weight: 600; font-size: 18px; margin-bottom: 0; color:#000">Hi,   {{ $mailData['user'] ?? ""}}
                         ...
                         Your publisher account has been deactivated due to a violation of the terms of service  on our platform. If you feel your deactivation is in error please contact <a href="mailto:Management@vivpanel.com" class="hover-underline" style="--text-opacity: 1; color: #7367f0; color: rgba(115, 103, 240, var(--text-opacity)); text-decoration: none;">Management@vivpanel.com</a> for further review.</p>
