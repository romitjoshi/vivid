                    ...
                    <tr>
                      <td class="sm-px-24" style="--bg-opacity: 1; background-color: #ffffff; border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding: 48px; text-align: left; --text-opacity: 1; color: #626262;" align="left">
                        <p style="font-weight: 600; font-size: 18px; margin-bottom: 0; color:#000">Hi, Admin
                         ...
                         {{ $mailData['publisher_name'] ?? ""}} has created a Episode {{ $mailData['episode_name'] ?? ""}} under the comic {{ $mailData['comic_name'] ?? ""}}. You can change the status of the episode by making it either active or inactive from the admin panel under Comics-> Approved Comic. Please click the button below to login with your admin account so that you can easily activate or inactivate the episode under the comic.
