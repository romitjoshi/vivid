                    ...
                    <tr>
                      <td class="sm-px-24" style="--bg-opacity: 1; background-color: #ffffff; border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding: 48px; text-align: left; --text-opacity: 1; color: #626262;" align="left">
                        <p style="font-weight: 600; font-size: 18px; margin-bottom: 0; color:#000">Hi,   {{ $mailData['publisher_name'] ?? ""}}
                         ...
                         Your Licensing Agreement and/or Tax document has been rejected for the following reason(s)
                         </p>
                         ...
                         <p style="margin: 20px 0; color:#000">
                         Click the button below to login with your publisher account and re-upload the document for approval or contact <a href="mailto:management@vivpanel.com" class="hover-underline" style="--text-opacity: 1; color: #7367f0; color: rgba(115, 103, 240, var(--text-opacity)); text-decoration: none;">management@vivpanel.com</a> for assistance.
                         </p>
