                  ...
                  <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                    <tr>
                      <td class="sm-px-24" style="--bg-opacity: 1; background-color: #ffffff; border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding: 48px; text-align: left; --text-opacity: 1; color: #626262;" align="left">
                        <p style="font-weight: 600; font-size: 18px; margin-bottom: 0; color:#000">Hi,   {{ $mailData['publisher_name'] ?? ""}}
                        </p>

                         <p style="margin: 20px 0; color:#000">
                         Your Licensing Agreement and Tax documents have been approved. You can now start creating episodes. Please click the button below to login with your publisher account and start creating content.
                         </p>

                         <p style="margin-top:60px; color:#000">
                            <a href="{{ $mailData['link'] ?? '' }}" style="display: block; font-weight: 600; font-size: 14px; line-height: 100%; padding: 16px 24px; --text-opacity: 1; color: #ffffff; color: rgba(255, 255, 255, var(--text-opacity)); text-decoration: none;    width: 30%;background-color: #0d6efd;color: #fff;" >Login</a>
                        </p>
