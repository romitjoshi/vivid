                    ...
                    <tr>
                      <td class="sm-px-24" style="--bg-opacity: 1; background-color: #ffffff; border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding: 48px; text-align: left; --text-opacity: 1; color: #626262;" align="left">
                        <p style="font-weight: 600; font-size: 18px; margin-bottom: 0; color:#000">Hi, Admin
                         ...
                         {{ $mailData['pub_name'] ?? ""}} has created a comic  {{ $mailData['comic_name'] ?? ""}} and is now asking for its approval. You can approve or reject the comic from the admin panel under Comics-> Unapproved Comic.Please click the button below to login with your admin account so that once the comic gets approved, it can be easily viewable and readable by other comic lovers.
