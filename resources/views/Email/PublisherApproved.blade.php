                    ...
                    <tr>
                      <td class="sm-px-24" style="--bg-opacity: 1; background-color: #ffffff; border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding: 48px; text-align: left; --text-opacity: 1; color: #626262;" align="left">
                        <p style="font-weight: 600; font-size: 18px; margin-bottom: 0; color:#000">Hi {{ $mailData['user'] ?? ""}},
                         ...
                         Congratulations! Your account has been approved! You can now publish your comics on the platform. You’ve been given access to the Publisher Portal where you can:
                         </p>

                         <p>
                         <ul style="margin-bottom: 24px; color:#000">
                            <li><b>View/edit comic info</b></li>
                            <li><b>Check your wallet balance</b> </li>
                            <li><b>See your episode views</b></li>
                            <li><b>Obtain your unique referral link</b></li>
                          </ul>
                         </p>

                        <p style="margin: 0 0 0px; color:#000">
                        Please click the button below to login with your publisher account.
                        </p>
