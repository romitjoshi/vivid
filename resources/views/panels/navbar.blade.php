        ...
        <li class="nav-item dropdown dropdown-user">
          <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-bs-toggle="dropdown" aria-haspopup="true">
            ...
            <span class="avatar">
              ...
              <img class="round" src="{{asset('images/avatars/userdummy.png')}}" alt="avatar" height="40" width="40">
              @else
              <img src="{{ env('IMAGE_PATH_medium') }}{{ Auth::User()->image }}" class="round"  alt="avatar img" height="40" width="40">
              @endif
