        ...
        <div class="card-body">
          <div class="tab-content">
            ...
            >
              ...
              <!-- <div class="d-flex">
                <a href="#" class="me-25">
                <img class="rounded me-50" src="{{asset('images/portrait/small/userdummy.png')}}"
              ...
              <div class="col-12">
                    <div class="d-flex align-items-center mb-2">
                      ...
                      <h4 class="mb-0 ms-75">General Form</h4>
                    </div>
                  </div>
              <form class="validate-form mt-2" enctype="multipart/form-data" id="generalForm">
                ...
                <div class="row">
                  ...
                  <div class="col-12 col-sm-6">
                    <div class="mb-1">
                      <label class="form-label" for="account-e-mail">Image [Recommended size 400 * 600 ]</label>
                      <input type="file" class="form-control dt-full-name" name="image" placeholder="Image" accept="image/png, image/gif, image/jpeg, image/jpg" />

                    </div>
                  </div>
                  <div class="col-12 col-sm-6">
                    <div class="mb-1">
                    <img src="{{ env('IMAGE_PATH_medium') }}{{ $profile->image }}" class="img-fluid rounded mt-2"  alt="avatar img" width="50">
                    </div>
                  </div>
                  ...
                  <div class="col-12 mt-2">
                    ...
                    <button type="submit" class="btn btn-primary data-submit me-1"><div class="spinner-border text-light importloader dNone" role="status"></div>Save changes</button>
              ...
              <form class="validate-form" id="passwordForm">
                ...
                <div class="col-12">
                    <div class="d-flex align-items-center mb-2">
                      ...
                      <h4 class="mb-0 ms-75">Password</h4>
                    </div>
                  </div><br>
                  <div class="col-12 col-sm-6">
                    <div class="mb-1">
