      ...
      <form class="modal-content pt-0" id="insertForm">
        ...
        <div class="modal-body flex-grow-1">
          <div class="mb-1">
            ...
            <input type="text" class="form-control dt-full-name" name="category_name" placeholder="Name" />
          </div>
    ...
    <div class="modal-dialog sidebar-sm">
      <form class="modal-content pt-0" id="updateForm">
        ...
        <div class="modal-body flex-grow-1">
          <div class="mb-1">
            <label class="form-label">Category Name</label>
            <input type="text" class="form-control dt-full-name" name="category_name" id="category_name" placeholder="Name" />
          </div>
...
@endsection
@section('page-script')
  <script src="{{ asset('js/custom/admin/category.js') }}"></script>
